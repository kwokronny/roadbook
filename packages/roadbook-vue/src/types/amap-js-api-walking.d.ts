...
declare namespace AMap {
  ...
  class Walking extends EventEmitter {
      ...
      search(
          ...
          callback?: (status: Walking.SearchStatus, result: Walking.SearchResultBase | string) => void,
      ): void;
      /**
       * 根据起点终点名称查询路径规划
       * @param point 名称数组
      ...
      search(
          ...
          callback?: (status: Walking.SearchStatus, result: Walking.SearchResultExt | string) => void,
      ): void;
      /**
       * 清除搜索的结果
       */
