...
*/
const icons = {
  'solar': ['add-square-linear', 'upload-square-linear',

  ],
  "fluent-emoji": ["handshake", "cityscape", "cityscape-at-dusk","calendar","umbrella-on-ground"]
};
...
// Save CSS file
await writeFile('src/style/icon.css', code, 'utf8');
