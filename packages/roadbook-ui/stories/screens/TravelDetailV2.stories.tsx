...
function ScheduleCard({
  ...
  const coverColors: Record<string, React.CSSProperties> = {
    ...
    hotel: { background: 'rgba(61,90,128,0.10)', border: '1px solid rgba(61,90,128,0.15)' },
  ...
  return (
    <div className="mx-4 mb-3 relative z-[1]">
      ...
      <div
        ...
        style={{
          background: isDark ? 'rgba(61,90,128,0.08)' : 'rgba(255,255,255,0.52)',
          backdropFilter: 'blur(40px) saturate(1.4)',
          WebkitBackdropFilter: 'blur(40px) saturate(1.4)',
          border: isDark ? '1px solid rgba(61,90,128,0.15)' : '1px solid rgba(255,255,255,0.65)',
        ...
        <div className="flex gap-2.5 items-start relative z-[1]">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between">
              ...
              <Icon name="more-h" size={16} style={{ color: isDark ? '#3D5A80' : 'rgba(28,28,30,0.28)' }} />
            </div>
            <div
              className="text-[16px] font-medium leading-snug line-clamp-2 mt-1"
              style={{ color: isDark ? '#2C4A6E' : undefined }}
            >
              {title}
            </div>
            {address && (
              <div
                ...
                style={{ color: isDark ? 'rgba(61,90,128,0.50)' : undefined }}
              >
            ...
            <div className="flex gap-1 mb-2">
              {Array.from({ length: photos }).map((_, i) => (
                <div
                  ...
                  style={{
                    borderRadius: 8,
                    background: isDark ? 'rgba(61,90,128,0.08)' : 'rgba(28,28,30,0.05)',
                  }}
                />
              ))}
            </div>
